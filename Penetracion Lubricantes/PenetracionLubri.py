...
turnos_posibles = [1,2,3]
for turno in turnos_posibles:
    if f'TURNO {turno}' not in ventaLubricantesM.columns:
        ventaLubricantesM[f'TURNO {turno}'] = 0
...
for turno in turnos_posibles:
    if f'TURNO {turno}' not in ventaLubricantes.columns:
        ventaLubricantes[f'TURNO {turno}']=0
