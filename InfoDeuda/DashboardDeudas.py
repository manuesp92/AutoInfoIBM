...
from DeudaClientesAyer import deuda as deudaAyer,total as totalAyer, adelantado as adelantadoAyer,precioGO as precioAyer,adelantado1
from DeudaClientesMesPasado import deuda2 as deudaMes,total2 as totalMes, adelantado2 as adelantadoMes,precioGO2 as precioMes
from DeudaClientesSemanaPasada import deuda1 as deudaSem,total1 as totalSem, adelantado1 as adelantadoSem,precioGO1 as precioSem
import datetime
...
df_to_image(adelantado1, ubicacion, 'Adelantado_Listado.png')
