...
AND CAST(a.Fecha AS DATE) = CAST(GETDATE() - 1 AS DATE)
...
fondoInicial['SALDO CAJA'] = fondoInicial['SALDO CAJA'].fillna(0)
fondoInicial['SALDO DOLARES'] = fondoInicial['SALDO DOLARES'].fillna(0)
