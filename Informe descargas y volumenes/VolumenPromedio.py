...
SET @finMesActualAnioAnterior = DATEADD(DAY, -1, DATEADD(MONTH, DATEDIFF(MONTH, -1, GETDATE()) - 12, 0))
...
def totales(df):
    df.loc["colTOTAL"]= pd.Series(
        ...
        ,index=['Despachos Proyectados Mes Actual','Despachos Mes Anterior'
                ...
                'Volumen Vendido 2022', 'Variacion Despacho Intermensual %'])
    ...
    tasa4 = ((df.loc["colTOTAL",'Volumen Promedio Mensual Proyectado'] -df.loc["colTOTAL",'Volumen Promedio Año 2022'])/
        df.loc["colTOTAL",'Volumen Promedio Año 2022'])
    df.fillna({'Variacion Interanual %':tasa4}, inplace=True)
    
    tasa5 = ((df.loc["colTOTAL",'Volumen Promedio Mensual Proyectado'] - df.loc["colTOTAL",'Volumen Promedio Mes Anterior'] )/
        df.loc["colTOTAL",'Volumen Promedio Mes Anterior'])
    df.fillna({'Variacion Intermensual %':tasa5}, inplace=True)
    
    tasa6= ((df.loc["colTOTAL", 'Despachos Proyectados Mes Actual']-df.loc["colTOTAL", 'Despachos Mes Anterior'] )/
           df.loc["colTOTAL", 'Despachos Mes Anterior'])
    df.fillna({'Variacion Despachos Intermensual %':tasa6}, inplace=True)
    
    tasa7= ((df.loc["colTOTAL", 'Despachos Proyectados Mes Actual']-df.loc["colTOTAL", 'Despachos 2022'])/
           df.loc["colTOTAL", 'Despachos 2022'])
...
despachosGO= despachosGO.rename(columns={'Variacion Intermensual %': 'Variacion Consumo Promedio Intermensual %', 'Variacion Interanual %': 'Variacion Consumo Promedio Interanual %','Variacion Despachos Interanual %':'Variacion Clientes Interanual %'})
despachosEU= despachosEU.rename(columns={'Variacion Intermensual %': 'Variacion Consumo Promedio Intermensual %', 'Variacion Interanual %': 'Variacion Consumo Promedio Interanual %','Variacion Despachos Interanual %':'Variacion Clientes Interanual %'})
despachosNS= despachosNS.rename(columns={'Variacion Intermensual %': 'Variacion Consumo Promedio Intermensual %', 'Variacion Interanual %': 'Variacion Consumo Promedio Interanual %','Variacion Despachos Interanual %':'Variacion Clientes Interanual %'})
despachosNU= despachosNU.rename(columns={'Variacion Intermensual %': 'Variacion Consumo Promedio Intermensual %', 'Variacion Interanual %': 'Variacion Consumo Promedio Interanual %','Variacion Despachos Interanual %':'Variacion Clientes Interanual %'})
despachosGNC= despachosGNC.rename(columns={'Variacion Intermensual %': 'Variacion Consumo Promedio Intermensual %', 'Variacion Interanual %': 'Variacion Consumo Promedio Interanual %','Variacion Despachos Interanual %':'Variacion Clientes Interanual %'})

percColsPorcentaje = ['Variacion Consumo Promedio Interanual %', 'Variacion Clientes Interanual %']

despachosGO= despachosGO.reindex(columns=['UEN', 'Variacion Consumo Promedio Interanual %','Variacion Clientes Interanual %'])
despachosEU= despachosEU.reindex(columns=['UEN', 'Variacion Consumo Promedio Interanual %','Variacion Clientes Interanual %'])
despachosNS= despachosNS.reindex(columns=['UEN', 'Variacion Consumo Promedio Interanual %','Variacion Clientes Interanual %'])
despachosNU= despachosNU.reindex(columns=['UEN', 'Variacion Consumo Promedio Interanual %','Variacion Clientes Interanual %'])
despachosGNC= despachosGNC.reindex(columns=['UEN','Variacion Consumo Promedio Interanual %','Variacion Clientes Interanual %'])
...
despachosGO = _estiladorVtaTitulo(despachosGO,percColsPorcentaje, "Evolucion Consumo Promedio por Cliente Ultra Diesel")
despachosEU = _estiladorVtaTitulo(despachosEU,percColsPorcentaje, "Evolucion Consumo Promedio por Cliente Infinia Diesel")
despachosNS = _estiladorVtaTitulo(despachosNS,percColsPorcentaje, "Evolucion Consumo Promedio por Cliente Nafta Super")
despachosNU = _estiladorVtaTitulo(despachosNU,percColsPorcentaje, "Evolucion Consumo Promedio por Cliente Infinia Nafta")
despachosGNC = _estiladorVtaTitulo(despachosGNC,percColsPorcentaje,"Evolucion Consumo Promedio por Cliente GNC")
