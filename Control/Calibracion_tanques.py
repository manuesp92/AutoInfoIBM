...
SELECT V.UEN, V.CODPRODUCTO, V.VOLFINAL AS VOLINICIAL
...
#alerta= _estiladorVtaTituloP(alerta, numCols, numCols0, percColsPen, 'Mermas Liquidos Acumulado',0)
alerta= _estiladorVtaTituloP(alerta, numCols, numCols0, percColsPen, 'Mermas Liquidos Acumulado Mensual',0)
