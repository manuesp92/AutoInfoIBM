...
def calcularCalibracion(histAforosInicial, histAforosFinal):
    ...
    for i in histAforosFinal.index:
        if (histAforosFinal.loc[i,'VOLFINELEC']-histAforosInicial.loc[i,'VOLINIELEC']) < -800000:
            print('entro')
            histAforosInicial.loc[i,'Vta s/Elec']= histAforosFinal.loc[i,'VOLFINELEC']-histAforosInicial.loc[i,'VOLINIELEC']+1000000
            histAforosInicial.loc[i,'Vta s/Auto']= histAforosFinal.loc[i,'VOLFINAUTO']-histAforosInicial.loc[i,'VOLINIAUTO']+1000000
        else:
            histAforosInicial.loc[i,'Vta s/Elec']= histAforosFinal.loc[i,'VOLFINELEC']-histAforosInicial.loc[i,'VOLINIELEC']
            histAforosInicial.loc[i,'Vta s/Auto']= histAforosFinal.loc[i,'VOLFINAUTO']-histAforosInicial.loc[i,'VOLINIAUTO']
