...
primer_dia_mes_anterior = datetime(ultimo_dia_mes_anterior.year, ultimo_dia_mes_anterior.month,
...
mbcTotalEU['UEN'] = mbcTotalEU['UEN'].str.strip()
mbcTOTALGO['UEN'] = mbcTOTALGO['UEN'].str.strip()
print(mbcTotalEU)
print(mbcTOTALGO)
