...
df_gasoleosTotal = df_gasoleosTotal.reindex(columns=['UEN','FECHASQL','Presupuesto Diario','CODPRODUCTO','Volumen Total Vendido'])
df_gasoleosTotal = df_gasoleosTotal.fillna(0)
...
df_gasoleosTotal = df_gasoleosTotal.reindex(columns=['UEN','Presupuesto Diario','CODPRODUCTO','Volumen Total Vendido'])
...
mbcTOTAL = df_gasoleosTotal.merge(df_gasoleosdapsa,on=['UEN','CODPRODUCTO','Volumen Total Vendido','Presupuesto Diario'],how='outer')


## Creo Dataframe de GO
GO = mbcTOTAL['CODPRODUCTO'] == "GO"
mbcTOTALGO = mbcTOTAL[GO]
mbcTOTALGO = mbcTOTALGO.rename({'Presupuesto Diario':'Presupuesto Acumulado L'},axis=1)
mbcTOTALGO = mbcTOTALGO.reindex(columns=['UEN','Presupuesto Acumulado L','Volumen Total Vendido'])
## Creo Dataframe de EU
EU = mbcTOTAL['CODPRODUCTO'] == "EU"
mbcTotalEU = mbcTOTAL[EU]
mbcTotalEU = mbcTotalEU.rename({'Presupuesto Diario':'Presupuesto Acumulado L'},axis=1)
mbcTotalEU=mbcTotalEU.reindex(columns=['UEN','Presupuesto Acumulado L','Volumen Total Vendido'])
mbcTotalEU= mbcTotalEU.loc[mbcTotalEU["Volumen Total Vendido"] != 0,:]
...
mbcTOTALGO=mbcTOTALGO.reindex(columns=['UEN','Presupuesto Acumulado L','Volumen Total Vendido','Desvio Presupuestado L','Desvio Presupuestado L %'])
...
mbcTotalEU=mbcTotalEU.reindex(columns=['UEN','Presupuesto Acumulado L','Volumen Total Vendido','Desvio Presupuestado L','Desvio Presupuestado L %'])
...
mbcTOTALGO = _estiladorVtaTituloD(mbcTOTALGO,EUmColslitros,percColsPen, "Ejecucion Presupuestaria Ultra Diesel")
mbcTotalEU = _estiladorVtaTituloD(mbcTotalEU,EUmColslitros,percColsPen, "Ejecucion Presupuestaria Infinia Diesel")
